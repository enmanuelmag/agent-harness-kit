...
function grokAgentFiles(config: HarnessConfig): AgentFileEntry[] {
  ...
  return [
    {
      relPath: '.grok/agents/lead.md',
      content: translateFrontmatterForGrok(
        agentLead({ projectName }, '', renderDelegationGuidance('grok-cli', 'lead')),
        'lead'
      ),
    },
    {
      relPath: '.grok/agents/explorer.md',
      content: translateFrontmatterForGrok(agentExplorer({ projectName }), 'explorer'),
    },
    {
      relPath: '.grok/agents/consultant.md',
      content: translateFrontmatterForGrok(agentConsultant({ projectName }), 'consultant'),
    },
    {
      relPath: '.grok/agents/builder.md',
      content: translateFrontmatterForGrok(agentBuilder({ projectName }), 'builder'),
    },
    {
      relPath: '.grok/agents/reviewer.md',
      content: translateFrontmatterForGrok(agentReviewer({ projectName }), 'reviewer'),
    },
  ]
}
